(() => {
	...
	i.n = e => {
							...
							switch (o.label) {
								...
								case 4:
									return t = i, n = g(g(g([], e.map((function(e) {
										...
										user_id: v
									}, window.fetch("/pokisdk/null.html?https://t.poki.io/game-cookies", {
										method: "post",
		...
		const D = function(e) {
			r.debug ? console.log(e) : fetch("/pokisdk/null.html?https://t.poki.io/adserver", {
				method: "POST",
				mode: "no-cors",
				...
				if (tt.prebidAvailable) {
					...
					var n = ["US", "CA", "AU"],
						...
						d = {
							...
							cache: {
								url: "/pokisdk/null.html?https://prebid.adnxs.com/pbc/v1/cache"
							},
							targetingControls: {
							...
							if (s) {
								if (c) {
									var w = function(e) {
										...
										return n ? {
											bid: n,
											vast: "/pokisdk/null.html?https://aax.amazon-adsystem.com/e/dtb/vast?b=" + I("amzniid", t) + "&rnd=" + Math.round(1e10 * Math.random()) + "&pp=" + i
										} : null
									}(c);
								...
								if (1 !== d && (!k || !k.videoCacheKey || k.cpm < B(o))) {
									...
									"ninja.io" === (null === (g = null === window || void 0 === window ? void 0 : window.location) || void 0 === g ? void 0 : g.hostname) && (S = function(e) {
										...
										cpm: S,
										vast: "/pokisdk/null.html?https://api.poki.com/ads/houseads/video/vast" + ("" === $e.gameId ? "" : "?game_id=" + $e.gameId),
										bidder: "poki",
										videoCacheKey: "poki"
									}
								}
								...
								switch (k.bidder) {
									case "onetag":
										v = "/pokisdk/null.html?https://onetag-sys.com/invocation/?key=" + k.videoCacheKey;
										break;
									case "rubicon":
										v = "/pokisdk/null.html?https://prebid-server.rubiconproject.com/cache?uuid=" + k.videoCacheKey;
										break;
									case "spotx":
										v = "/pokisdk/null.html?https://search.spotxchange.com/ad/vast.html?key=" + k.videoCacheKey;
										break;
									case "amazon":
									case "poki":
										v = k.vast;
										break;
									default:
										v = "/pokisdk/null.html?https://prebid.adnxs.com/pbc/v1/cache?uuid=" + k.videoCacheKey
								}
								D({
									event: "video-ready",
									size: "640x360v",
		...
		function ye() {
			if (document.body && document.body.appendChild) {
				...
				if (e.style.display = "none", document.body.appendChild(e), e.contentWindow && (window.pokiKeysChanged = new Map, e.contentWindow.document.open(), e.contentWindow.document.write("<script>\nconst lsKey = 'poki_lsexpire';\nconst lifetime = 1000*60*60*24*30*6;\n\nwindow.addEventListener('storage', function(event) {\n\ttry {\n\t\tconst key = event.key;\n\n\t\t// key is null when localStorage.clear() is called.\n\t\tif (key === null) {\n\t\t\tlocalStorage.removeItem(lsKey);\n\t\t\treturn;\n\t\t}\n\n\t\tif (key === lsKey) return;\n\n\t\tconst updates = JSON.parse(localStorage.getItem(lsKey)) || {};\n\n\t\t// newValue is null when localStorage.removeItem() is called.\n\t\tif (event.newValue === null) {\n\t\t\tdelete updates[key];\n\n\t\t\t// window.parent is the game itself. This code is executed in\n\t\t\t// an iframe without src which makes it the same context as it's parent\n\t\t\t// which makes it save to access the parent's properties.\n\t\t\twindow.parent.pokiKeysChanged.set(key, 'remove');\n\t\t} else {\n\t\t\tupdates[key] = Date.now();\n\t\t\twindow.parent.pokiKeysChanged.set(key, 'set');\n\t\t}\n\t\tlocalStorage.setItem(lsKey, JSON.stringify(updates));\n\t} catch (e) {}\n});\n\nfunction expire() {\n\tconst updates = JSON.parse(localStorage.getItem(lsKey)) || {};\n\tconst expireBefore = Date.now() - lifetime;\n\tvar removed = false;\n\n\tObject.keys(updates).map(function(key) {\n\t\tif (updates[key] < expireBefore) {\n\t\t\tlocalStorage.removeItem(key);\n\t\t\tdelete updates[key];\n\t\t\tremoved = true;\n\t\t}\n\t});\n\n\tif (removed) {\n\t\tlocalStorage.setItem(lsKey, JSON.stringify(updates));\n\t}\n}\n\ntry {\n\texpire();\n} catch (e) {}\n<\/script>"), e.contentWindow.document.close(), !window.location.hostname.endsWith("poki-gdn.com") && $e.gameId)) {
					...
					t.style.display = "none", t.src = "/pokisdk/null.html?https://" + $e.gameId + ".poki-gdn.com/poki-savegame-store.html", t.onload = function() {
		...
		const je = function() {
			...
			return fetch("/pokisdk/null.html?https://devs-api.poki.com/gameinfo/@sdk?href=" + t + "&referrer=" + i, {
				method: "GET",
				headers: {
		...
		var Je = function() {
			...
			et = function() {
				...
				return e.prototype.init = function(e) {
					...
					var T = [k(), S()],
						_ = Ye(Ye([], T, !0), [Ge()], !1);
					this.isBot || (_.push(Pe("/pokisdk/null.html?https://imasdk.googleapis.com/js/sdkloader/ima3.js"), Pe("/pokisdk/null.html?https://securepubads.g.doubleclick.net/tag/js/gpt.js")), (I("url_referrer") || "").includes("kiloo.com") ? (e.prebidAvailable = !1, e.childDirected = !0, e.nonPersonalized = !0, this.IGD.enforceChildSafety()) : _.push(Pe("/pokisdk/null.html?https://a.poki.com/prebid/prebid6.12.0.js"), Pe("/pokisdk/null.html?https://c.amazon-adsystem.com/aax2/apstag.js")));
			...
			if ($e.gameId && $e.versionId) {
				if (!(Date.now() < At)) try {
					var t = JSON.stringify({
						...
						i = "/pokisdk/null.html?https://t.poki.io/ge";
